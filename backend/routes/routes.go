...
func SetupRoutes(router fiber.Router) {
	...
	documentsGroup.Get("/:id/fields", controllers.GetDocumentFields)
	...
	documentsGroup.Put("/:id/fields", controllers.UpdateDocumentFields)
	documentsGroup.Delete("/:id/fields", controllers.DeleteDocumentFields)
	...
	templatesGroup.Get("/:id/download", controllers.DownloadTemplateFile)
	...
	teamGroup.Post("/users/:id/reset-password", controllers.ResetTeamUserPassword)
	teamGroup.Delete("/users/:id", controllers.DeleteTeamUser)
	...
	companyDirectoryGroup := router.Group("/company-directory", middlewares.ProtectedMiddleware())
	companyDirectoryGroup.Get("/options", controllers.GetCompanyDirectoryOptions)
	companyDirectoryGroup.Get("/departments/:id/collaborators", controllers.GetCompanyCollaboratorsByDepartment)
	companyDirectoryGroup.Post("/sync-collaborators", controllers.SyncCompanyCollaborators)
	companyDirectoryGroup.Get("/collaborators", controllers.ListSyncedCompanyCollaborators)
